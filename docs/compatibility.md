...
Paper 1.21.4 / 1.21.8 / 1.21.11 / 26.1.2 / 26.2 に対応しています。26.1.2 / 26.2 は Java 25でのサーバー起動とプラグイン有効化を確認済みです。Mineflayerのプロトコル未対応により26.xのゲームプレイE2E完走確認は未完了ですが、プラグイン本体は対応済みとして扱います。
